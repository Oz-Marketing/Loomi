...
export default function AdGeneratorListPage() {
  ...
  const visible = useMemo(() => {
    ...
    return list;
  }, [creatives, statusFilter, sourceFilter, search, templates]);
          ...
          <ListToolbar
            leading={
              <div className="flex items-center gap-3">
                ...
                {/* Manual / automated split. Only shown once the account actually
                    HAS automated ads — until the nightly job has produced
                    something, the distinction is noise. */}
                {(creatives ?? []).some((c) => c.autoGenerated) && (
