  ...
  return (
    <div className="py-6">
      <div className="flex items-center justify-between gap-4">
        ...
        <Link
          href="/projects/new"
          className="inline-flex items-center gap-2 rounded-xl bg-[var(--primary)] px-3.5 py-2 text-sm font-medium text-[var(--primary-foreground)] accent-glow transition hover:opacity-90"
        >
