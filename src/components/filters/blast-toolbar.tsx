...
export interface BlastFilterState {
  account: string[];
  status: string[];
  oem: string[];
  industry: string[];
...
export interface BlastFilterOptions {
...
export function BlastToolbar({
  ...
  function setFilter<K extends keyof BlastFilterState>(key: K, values: BlastFilterState[K]) {
    onFiltersChange({ ...filters, [key]: values });
  }

  function toggleFilterValue<K extends keyof BlastFilterState>(key: K, value: string) {
    setFilter(key, toggleSelection(filters[key], value) as BlastFilterState[K]);
  }

  function clearFilter<K extends keyof BlastFilterState>(key: K) {
    setFilter(key, [] as BlastFilterState[K]);
  }
