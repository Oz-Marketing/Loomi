      ...
      {open && coords &&
        ...
        createPortal(
          <div
            ...
            className={`animate-dropdown-in fixed z-[200] rounded-lg border border-[var(--border)] bg-[var(--card-strong)] backdrop-blur-2xl backdrop-saturate-150 shadow-xl overflow-hidden focus:outline-none ${popoverClassName ?? ''}`}
            style={{
              top: coords.top,
              left: coords.left,
