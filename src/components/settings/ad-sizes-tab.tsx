 ...
 *
 * A STUDIO settings tab (Settings → Ad Sizes). It used to be its own page under
 * /ad-generator, reached from a cog on the generator's header; the library is
 * configuration the whole sector reads, so it belongs in the sector's settings
 * rail. That route redirects here.
 *
    ...
    <div>
      <header className="mb-6 flex flex-wrap items-start justify-between gap-3">
        ...
        <Link
          ...
          className="flex flex-shrink-0 items-center gap-1.5 rounded-lg border border-[var(--border)] px-3 py-1.5 text-xs font-medium text-[var(--foreground)] transition-colors hover:bg-[var(--muted)]/40"
        >
