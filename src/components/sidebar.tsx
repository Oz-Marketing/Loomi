...
export function Sidebar() {
  ...
  // Always `/settings` — the per-account settings this used to deep-link into
  // live on the account itself now (Agency Settings → Accounts), and the slug
  // route that served them is gone.
