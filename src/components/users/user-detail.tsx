...
/**
 * The routed page at /users/[id] (and its /settings/users/[id] mirror).
 *
 * Both this and the embedded {@link UserDetail} live here rather than in the
 * route file: a Next.js `page.tsx` may export nothing but a default and the
 * framework's own fields, so an editor that two hosts need can't live in one.
 */
