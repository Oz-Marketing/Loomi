...
function offerFields(prefix: string, group: string): FieldSpec[] {
  ...
  return [
    ...
    { key: `${prefix}securityDeposit`, label: 'Security deposit ($)', type: 'text', group, placeholder: '0', help: 'Some OEM programs require stating it (e.g. Subaru).', visibleWhen: { field: t, in: ['lease', 'apr', 'discount', 'sales_price'] } },
