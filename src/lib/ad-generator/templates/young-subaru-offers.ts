...
/**
 * Young Subaru offer templates, built NATIVELY on the unified Background element
 * (base fill + white fade + an empty texture slot the designer fills once from
 * the Textures library + a Young|Subaru logo element) — so one background
 * reflows across every size, replacing the old per-size Illustrator plates.
 *
...
/** The native Background element: base fill + white fade + empty texture slot.
 *  Fade angle/length differ by set (single = diagonal; dual = top band). */
function backgroundEl(angle: number, fadeEnd: number): DocElement {
  const overlay: GradientFill = { type: 'linear', angle, stops: [{ color: '#ffffff', pos: 0 }, { color: '#ffffff', pos: fadeEnd, opacity: 0 }] };
  return { id: 'bg', type: 'background', name: 'Background', binding: { kind: 'static', value: '' }, fit: 'cover', fill: BASE, overlay };
}
...
const singleLayouts: Record<string, Record<string, DocLayoutBox>> = {
  fb: {
    bg: b(0, 0, 1, 1, 0), logo: b(0.04, 0.08, 0.13, 0.12, 5),
  ...
  email: {
    bg: b(0, 0, 1, 1, 0), logo: b(0.05, 0.07, 0.16, 0.13, 5),
  ...
  google: {
    bg: b(0, 0, 1, 1, 0), logo: b(0.05, 0.06, 0.28, 0.13, 5),
  ...
  ksl600: {
    bg: b(0, 0, 1, 1, 0), logo: b(0.07, 0.04, 0.3, 0.06, 5),
  ...
  ksl850: {
    bg: b(0, 0, 1, 1, 0), logo: b(0.07, 0.03, 0.3, 0.045, 5),
...
const dualLayouts: Record<string, Record<string, DocLayoutBox>> = {
  ...
  fb: {
    bg: b(0, 0, 1, 1, 0), logo: b(0.04, 0.07, 0.11, 0.13, 5), tagline: b(0.17, 0.08, 0.66, 0.11, 5, 36),
  ...
  email: {
    bg: b(0, 0, 1, 1, 0), logo: b(0.05, 0.06, 0.14, 0.13, 5), tagline: b(0.2, 0.07, 0.6, 0.11, 5, 20),
  ...
  google: {
    bg: b(0, 0, 1, 1, 0), logo: b(0.36, 0.05, 0.28, 0.13, 5),
  ...
  ksl600: {
    bg: b(0, 0, 1, 1, 0), logo: b(0.07, 0.04, 0.3, 0.05, 5), tagline: b(0.07, 0.1, 0.86, 0.06, 5, 22),
  ...
  ksl850: {
    bg: b(0, 0, 1, 1, 0), logo: b(0.07, 0.03, 0.3, 0.04, 5), tagline: b(0.07, 0.08, 0.86, 0.05, 5, 24),
